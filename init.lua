...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep (Current Directory)' }) -- Able to find text in current directory
  ...
  require 'kickstart.plugins.indent_line', -- adds vertical lines to show indent levels
